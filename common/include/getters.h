...
namespace Inspection
{
	...
	std::unique_ptr< Inspection::Result > Get_ID3_2_3_Frame_Body_UFID(Inspection::Reader & Reader);
	...
	std::unique_ptr< Inspection::Result > Get_ID3_2_4_Frame_Body_APIC_PictureType(Inspection::Reader & Reader);
	...
	std::unique_ptr< Inspection::Result > Get_ID3_2_4_Tag_ExtendedHeader_Flag_Header(Inspection::Reader & Reader);
	...
	std::unique_ptr< Inspection::Result > Get_ID3_ReplayGainAdjustment_NameCode(Inspection::Reader & Reader);
	std::unique_ptr< Inspection::Result > Get_ID3_ReplayGainAdjustment_OriginatorCode(Inspection::Reader & Reader);
	std::unique_ptr< Inspection::Result > Get_ID3_ReplayGainAdjustment_ReplayGainAdjustment(Inspection::Reader & Reader);
	std::unique_ptr< Inspection::Result > Get_ID3_ReplayGainAdjustment_SignBit(Inspection::Reader & Reader);
