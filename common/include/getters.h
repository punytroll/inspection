...
namespace Inspection
{
	...
	std::unique_ptr< Inspection::Result > Get_APE_Tag(Inspection::Reader & Reader, const std::unordered_map< std::string, std::experimental::any > & Parameters);
	...
	std::unique_ptr< Inspection::Result > Get_Array_EndedByLength(Inspection::Reader & Reader, std::function< std::unique_ptr< Inspection::Result > (Inspection::Reader &, const std::unordered_map< std::string, std::experimental::any > &) > Getter);
	...
	std::unique_ptr< Inspection::Result > Get_ASF_CodecList_CodecEntry(Inspection::Reader & Reader, const std::unordered_map< std::string, std::experimental::any > & Parameters);
	...
	std::unique_ptr< Inspection::Result > Get_ASF_LanguageList_LanguageIDRecord(Inspection::Reader & Reader, const std::unordered_map< std::string, std::experimental::any > & Parameters);
	...
	std::unique_ptr< Inspection::Result > Get_ASF_StreamProperties_ErrorCorrectionData_AudioSpread(Inspection::Reader & Reader, const std::unordered_map< std::string, std::experimental::any > & Parameters);
