...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_DataObject(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		Inspection::Reader PartReader{Reader, Inspection::Length{std::experimental::any_cast< std::uint64_t >(Result->GetAny("Size")), 0} - Reader.GetConsumedLength()};
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_ExtendedContentDescription_ContentDescriptor(Inspection::Reader & Reader)
{
	...
	{
		Inspection::Reader PartReader{Reader};
		auto PartResult{g_GetterRepository.Get({"ASF", "ExtendedContentDescription_ContentDescriptor_ValueDataType"}, PartReader)};
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_HeaderObject(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		Continue = std::experimental::any_cast< Inspection::GUID >(Result->GetAny("GUID")) == Inspection::g_ASF_HeaderObjectGUID;
	}
	// reading
	if(Continue == true)
	{
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_Object(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		...
		{
			Inspection::Reader PartReader{Reader, Size - Reader.GetConsumedLength()};
			auto PartResult{g_GetterRepository.Get({"ASF", "FileProperties_ObjectData"}, PartReader)};
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_StreamProperties_TypeSpecificData_AudioMedia(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		...
		{
			Inspection::Reader PartReader{Reader, Inspection::Length{std::experimental::any_cast< std::uint16_t >(Result->GetAny("CodecSpecificDataSize")), 0}};
...
std::unique_ptr< Inspection::Result > Inspection::Get_ID3_2_2_Frame_Body_COM(Inspection::Reader & Reader)
{
	...
	{
		Inspection::Reader PartReader{Reader};
		auto PartResult{g_GetterRepository.Get({"ID3", "v2.2", "TextEncoding"}, PartReader)};
...
std::unique_ptr< Inspection::Result > Inspection::Get_RIFF_Chunk(Inspection::Reader & Reader)
{
	auto Result{Inspection::InitializeResult(Reader)};
	auto Continue{true};
...
std::unique_ptr< Inspection::Result > Inspection::Get_RIFF_fact_ChunkData(Inspection::Reader & Reader)
{
	auto Result{Inspection::InitializeResult(Reader)};
	auto Continue{true};
...
std::unique_ptr< Inspection::Result > Inspection::Get_RIFF_fmt_ChunkData_CommonFields(Inspection::Reader & Reader)
{
	auto Result{Inspection::InitializeResult(Reader)};
	auto Continue{true};
