...
std::unique_ptr< Inspection::Result > Inspection::Get_Array_EndedByNumberOfElements(Inspection::Reader & Reader, const std::unordered_map< std::string, std::experimental::any > & Parameters)
{
	...
	if(Continue == true)
	{
		...
		auto & Getter{std::experimental::any_cast< const std::vector< std::string > & >(Parameters.at("ElementGetter"))};
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_CompatibilityObjectData(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		...
		Continue = PartResult->GetSuccess();
		Result->GetValue()->AppendField("Profile", PartResult->GetValue());
		Reader.AdvancePosition(PartReader.GetConsumedLength());
	}
	// verification
	if(Continue == true)
	{
		Continue = std::experimental::any_cast< std::uint8_t >(Result->GetValue()->GetField("Profile")->GetData()) == 0x02;
	}
	// reading
	if(Continue == true)
	{
	...
	if(Continue == true)
	{
		Continue = std::experimental::any_cast< std::uint8_t >(Result->GetValue()->GetField("Mode")->GetData()) == 0x01;
	}
	// finalization
	Result->SetSuccess(Continue);
	Inspection::FinalizeResult(Result, Reader);
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_ExtendedContentDescription_ContentDescriptor(Inspection::Reader & Reader, const std::unordered_map< std::string, std::experimental::any > & Parameters)
{
	...
	if(Continue == true)
	{
		...
		Continue = PartResult->GetSuccess();
		Result->GetValue()->AppendField("NameLength", PartResult->GetValue());
		Reader.AdvancePosition(PartReader.GetConsumedLength());
	}
	// reading
	if(Continue == true)
	{
		Inspection::Reader PartReader{Reader, Inspection::Length{std::experimental::any_cast< std::uint16_t >(Result->GetValue()->GetField("NameLength")->GetData()), 0}};
		auto PartResult{Get_ISO_IEC_10646_1_1993_UTF_16LE_String_WithoutByteOrderMark_EndedByTerminationAndLength(PartReader, {})};
		
		Continue = PartResult->GetSuccess();
		Result->GetValue()->AppendField("Name", PartResult->GetValue());
		Reader.AdvancePosition(PartReader.GetConsumedLength());
	}
	// reading
	if(Continue == true)
	...
	if(Continue == true)
	{
		...
		Continue = PartResult->GetSuccess();
		Result->GetValue()->AppendField("ValueLength", PartResult->GetValue());
		Reader.AdvancePosition(PartReader.GetConsumedLength());
	}
	// reading
	if(Continue == true)
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_LanguageListObjectData(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		auto LanguageIDRecordsCount{std::experimental::any_cast< std::uint16_t >(Result->GetValue()->GetField("LanguageIDRecordsCount")->GetData())};
		Inspection::Reader PartReader{Reader};
		auto PartResult{Get_Array_EndedByNumberOfElements(PartReader, {{"ElementGetter", std::vector< std::string >{"ASF", "LanguageList", "LanguageIDRecord"}}, {"ElementName", "LanguageIDRecord"s}, {"NumberOfElements", static_cast< std::uint64_t >(LanguageIDRecordsCount)}})};
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_MetadataLibraryObjectData(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		auto DescriptionRecordsCount{std::experimental::any_cast< std::uint16_t >(Result->GetValue()->GetField("DescriptionRecordsCount")->GetData())};
		Inspection::Reader PartReader{Reader};
		auto PartResult{Get_Array_EndedByNumberOfElements(PartReader, {{"ElementGetter", std::vector< std::string >{"ASF", "MetadataLibrary", "DescriptionRecord"}}, {"ElementName", "DescriptionRecord"s}, {"NumberOfElements", static_cast< std::uint64_t >(DescriptionRecordsCount)}})};
...
std::unique_ptr< Inspection::Result > Inspection::Get_ASF_MetadataObjectData(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		auto DescriptionRecordsCount{std::experimental::any_cast< std::uint16_t >(Result->GetValue()->GetField("DescriptionRecordsCount")->GetData())};
		Inspection::Reader PartReader{Reader};
		auto PartResult{Get_Array_EndedByNumberOfElements(PartReader, {{"ElementGetter", std::vector< std::string >{"ASF", "Metadata", "DescriptionRecord"}}, {"ElementName", "DescriptionRecord"s}, {"NumberOfElements", static_cast< std::uint64_t >(DescriptionRecordsCount)}})};
...
std::unique_ptr< Inspection::Result > Inspection::Get_FLAC_Subframe(Inspection::Reader & Reader, std::uint16_t FrameBlockSize, std::uint8_t BitsPerSample)
{
	...
	if(Continue == true)
	{
		...
		{
			auto FieldResult{Get_FLAC_Subframe_Data_Fixed(Reader, FrameBlockSize, BitsPerSample, std::experimental::any_cast< std::uint8_t >(Result->GetValue()->GetField("Header")->GetField("Type")->GetField("Order")->GetData()))};
			auto FieldValue{Result->GetValue()->AppendField("Data", FieldResult->GetValue())};
		...
		{
			auto FieldResult{Get_FLAC_Subframe_Data_LPC(Reader, FrameBlockSize, BitsPerSample, static_cast< std::uint8_t >(std::experimental::any_cast< std::uint8_t >(Result->GetValue()->GetField("Header")->GetField("Type")->GetField("Order")->GetData()) + 1))};
			auto FieldValue{Result->GetValue()->AppendField("Data", FieldResult->GetValue())};
...
std::unique_ptr< Inspection::Result > Inspection::Get_FLAC_Subframe_Data_LPC(Inspection::Reader & Reader, std::uint16_t FrameBlockSize, std::uint8_t BitsPerSample, std::uint8_t PredictorOrder)
{
	...
	if(Continue == true)
	{
		auto FieldResult{Get_SignedIntegers_BigEndian(Reader, std::experimental::any_cast< std::uint8_t >(Result->GetValue()->GetField("QuantizedLinearPredictorCoefficientsPrecision")->GetTag("value")->GetData()), PredictorOrder)};
...
std::unique_ptr< Inspection::Result > Inspection::Get_ID3_2_4_Tag_ExtendedHeader_Flag_Data_CRCDataPresent(Inspection::Reader & Reader)
{
	...
	if(Continue == true)
	{
		Continue = std::experimental::any_cast< std::uint8_t >(Result->GetValue()->GetField("Size")->GetData()) == 0x05;
	}
	// reading
	if(Continue == true)
	{
...
{
	return Get_Array_EndedByNumberOfElements(Reader, {{"ElementGetter", std::vector< std::string >{"Number", "Integer", "Unsigned", "BigEndian"}}, {"ElementParameters", std::unordered_map< std::string, std::experimental::any >{{"Bits", Bits}}}, {"NumberOfElements", NumberOfElements}});
}
...
{
	return Get_Array_EndedByNumberOfElements(Reader, {{"ElementGetter", std::vector< std::string >{"Number", "Integer", "Unsigned", "16Bit_BigEndian"}}, {"NumberOfElements", NumberOfElements}});
}
...
std::unique_ptr< Inspection::Result > Inspection::Get_Vorbis_CommentHeader_UserComment(Inspection::Reader & Reader, const std::unordered_map< std::string, std::experimental::any > & Parameters)
{
	...
	if(Continue == true)
	{
		Inspection::Reader FieldReader{Reader, Inspection::Length{std::experimental::any_cast< std::uint32_t >(Result->GetValue()->GetField("Length")->GetData()), 0}};
