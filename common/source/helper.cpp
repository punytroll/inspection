...
std::string Inspection::Get_ID3_2_2_FrameIdentifier_Interpretation(const std::string & Value)
{
	if(Value == "COM")
	{
		return "Comment";
...
std::string Inspection::Get_ID3_2_3_FrameIdentifier_Interpretation(const std::string & Value)
{
	if(Value == "AENC")
	{
...
std::string Inspection::Get_ID3_2_4_FrameIdentifier_Interpretation(const std::string & Value)
{
	if(Value == "AENC")
	{
		return "Audio encryption";
