...
std::pair< int, std::string > Get_UCS_2_BE_StringTerminatedByLength(const uint8_t * Buffer, int Length)
{
	std::pair< int, std::string > Result;
	...
	while(true)
	{
		if(Result.first + 2 <= Length)
		{
			if(StartsWith_UCS_2_BE_Character(Buffer + Result.first, Length - Result.first) == true)
			{
				Result.second += Get_UTF_8_CharacterFrom_UCS_2_BE_Character(Buffer + Result.first, Length - Result.first);
				Result.first += 2;
			}
...
// UCS-2LE                                                                                       //
///////////////////////////////////////////////////////////////////////////////////////////////////
std::pair< int, std::string > Get_UCS_2_LE_StringTerminatedByEndOrLength(const uint8_t * Buffer, int Length)
{
	std::pair< int, std::string > Result;
...
std::pair< int, std::string > Get_UCS_2_LE_StringTerminatedByEnd(const uint8_t * Buffer, int Length)
{
	std::pair< int, std::string > Result;
...
std::pair< int, std::string > Get_UCS_2_LE_StringTerminatedByLength(const uint8_t * Buffer, int Length)
{
	std::pair< int, std::string > Result;
	...
	while(true)
	{
		if(Result.first + 2 <= Length)
		{
			if(StartsWith_UCS_2_LE_Character(Buffer + Result.first, Length - Result.first) == true)
			{
				Result.second += Get_UTF_8_CharacterFrom_UCS_2_LE_Character(Buffer + Result.first, Length - Result.first);
				Result.first += 2;
			}
...
// UTF-16BE                                                                                      //
///////////////////////////////////////////////////////////////////////////////////////////////////
int PrintUTF_16_BEStringTerminatedByEnd(const uint8_t * Buffer, int Length)
{
	int Index(0);
...
// UTF-16LE                                                                                      //
///////////////////////////////////////////////////////////////////////////////////////////////////
int PrintUTF_16_LEStringTerminatedByEnd(const uint8_t * Buffer, int Length)
{
	int Index(0);
...
// UTF-16                                                                                        //
///////////////////////////////////////////////////////////////////////////////////////////////////
int PrintUTF_16StringTerminatedByEnd(const uint8_t * Buffer, int Length)
{
	int Index(0);
...
int Handle22PICFrames(const uint8_t * Buffer, int Length)
{
	...
	if(std::get<0>(Encoding) == true)
	{
		...
		if(Length - Index >= 3)
		{
			auto ReadImageFormat(Get_ISO_IEC_8859_1_StringTerminatedByLength(Buffer + Index, 3));
		...
		if(StartsWith_ISO_IEC_8859_1_StringWithTermination(Buffer + Index, Length - Index) == true)
		{
			...
			if(ColonPosition != std::string::npos)
			{
				...
				if(Index < Length)
				{
					...
					{
						auto Value(Get_ISO_IEC_8859_1_StringTerminatedByLength(Buffer + Index, Length - Index));
...
int Handle23T___Frames(const uint8_t * Buffer, int Length)
{
	...
	if(std::get<0>(Encoding) == true)
	{
		...
		if(std::get<2>(Encoding) == TextEncoding::ISO_IEC_8859_1_1998)
		{
			...
			{
				auto ReadString(Get_ISO_IEC_8859_1_StringTerminatedByLength(Buffer + Index, Length - Index));
		...
		if(std::get<2>(Encoding) == TextEncoding::ISO_IEC_8859_1_1998)
		{
			if(StartsWith_ISO_IEC_8859_1_StringWithTermination(Buffer + Index, Length - Index) == true)
			{
				...
				if(Index < Length)
				{
					...
					{
						auto String(Get_ISO_IEC_8859_1_StringTerminatedByLength(Buffer + Index, Length - Index));
...
int Handle23UFIDFrame(const uint8_t * Buffer, int Length)
{
	...
	auto ReadIdentifier(GetHexadecimalStringTerminatedByLength(Buffer + Index, Length - Index));
